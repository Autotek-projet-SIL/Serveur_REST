...
routerFlotte.get("/flotte/vehicule_am/:id", controllerFlotte.getVehiclesByAmID);
...
routerFlotte.get("/flotte/typevehicule/", controllerFlotte.getVehiclesTypes);
...
//add a vehicule
routerFlotte.post("/flotte/ajouter_vehicule/", controllerFlotte.addVehicle);
...
//recuperate all vehicules marques
routerFlotte.get("/flotte/marque/", controllerFlotte.getMarques);
