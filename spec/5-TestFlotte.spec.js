...
it("Recuperer la liste des modèles vehicules d'une marque", async () => {
  await axios.get(url + "flotte/modelevehicule/test_marque1").then((res) => {
    ...
    it("Ajouter un véhicule", async () => {
        ...
        await axios
          .post(url + "flotte/ajouter_vehicule/", data)
          .then((res) => {
      ...
      it("Ajouter un type de véhicule", async () => {
        ...
        await axios
          .post(url + "flotte/ajouter_typevehicule/", data)
          .then((res) => {
            expect(res.status).toEqual(200);
          });
        await axios
        .get(url + "flotte/typevehicule/").then((res) => {
            res.data.forEach((element) => {
      ...
      it("Modifier un type de véhivule", async () => {
        ...
        await axios.put(
          url + "flotte/modifier_typevehicule/3",
          typevehicule
        );
        await axios
        .get(url + "flotte/typevehicule/").then((res) => {
      ...
      it("Supprimer un type de véhicule", async () => {
        await axios
          .delete(url + "flotte/supprimer_typevehicule/3")
          .then((res) => {
            expect(res.status).toEqual(200);
          });
          await axios
